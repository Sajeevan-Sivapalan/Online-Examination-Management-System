...
public class UpdateModule extends HttpServlet {
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		DAO.updateModule((String) request.getParameter("Mcode"), (String) request.getParameter("Mname"),
				(String) request.getParameter("Mdes"), (String) request.getParameter("Mpoints"));
